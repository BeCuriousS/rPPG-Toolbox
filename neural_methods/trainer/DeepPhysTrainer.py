...
class DeepPhysTrainer(BaseTrainer):
    ...
    def valid(self, data_loader):
        ...
        # NOTE: We adjusted this method so that the evaluation comprises the heart rate from the extracted BVP based on a peak detection in the frequency transformed signal
        print('')
        print("===Validating===")
        valid_loss = []
        self.model.eval()
        ...
        with torch.no_grad():
            ...
            for valid_idx, valid_batch in enumerate(vbar):
                ...
                loss_batch = []
                for i in range(N):
                    pred_ppg_valid = self.model(data_valid[i])
